...
# Test 04: Ensure simple division case has correct output...
...
# Test 05: Ensure simple multiplication case has correct output...
if [[ $($CALCULATOR 2 '*' 3) -ne 6 ]]; then
  echo 'ERROR! A valid run of the calculator (2 * 3) failed to produce 6 as an output!'
  exit 1
fi

# Test 06: Ensure simple subtraction case has correct output...
